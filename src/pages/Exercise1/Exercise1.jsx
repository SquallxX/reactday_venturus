...
class Exercise1 extends Component {
    ...
    async componentDidMount(){
        ...
        await axios.get(`https://pokeapi.co/api/v2/pokemon?limit=500`).then(res => {
            const availableElements2 = res.data.results.map((item, ix) => {
                return ({
                    number: getPokemonNumber(ix + 1),
                    ...item
                })
            });
            this.setState({ availableElements: availableElements2 });
        });
    }
